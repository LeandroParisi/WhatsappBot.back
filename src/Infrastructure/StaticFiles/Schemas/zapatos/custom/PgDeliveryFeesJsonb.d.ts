...
declare module 'zapatos/custom' {
  ...
  export type DeliveryFeeTypes = 'unique' | 'radius'

  interface DeliveryFee {
    type : DeliveryFeeTypes
    fees : string | Array<Array<number>>
  }

  export type PgDeliveryFeesJsonb = DeliveryFee;  // replace with your custom type or interface as desired
}
